...
class Toggl:
    ...
    def setAPIKey(self, APIKey):
        ...
        authHeader = '{}:api_token'.format(APIKey)
        base64string = base64.encodebytes(authHeader.encode('ascii')).decode('ascii')[:-1]
    ...
    def request(self, endpoint, parameters=None):
        ...
        return json.loads(self.requestRaw(endpoint, parameters).decode('utf_8'))
    ...
    def getWorkspaceProjects(self, id):
        """Return all the projects in the workspace"""
        return self.request('{}/{}/projects'.format(Endpoints.WORKSPACES, id))
